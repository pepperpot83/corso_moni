...
$array=array(
    ...
    */
    'Home'=>'/corso_moni/index.php',
    'il mio blog'=>'/corso_moni/blog.php',
    'Login'=>'/corso_moni/login.php'
    /*
...
$configDB=array(
    /* Array per la configurazione del DB */
    'server'=>'localhost',
...
if(isset($_COOKIE['LOGIN'])){
    ...
    $array['admin'] = '/corso_moni/admin/admin.php';
...
$arrayAdmin=array(
    'Pagine'=>'#',
    'Post'=>'/corso_moni/admin/adminPost.php'
);
...
function buildmenu ($idwrapper, $array){
    ...
    */
    foreach($array as $chiave=>$valore){
        $list.='<li><a href="'.$valore.'">'.$chiave.'</a></li>';
